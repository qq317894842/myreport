            ...
            return {
              ...
              /*  moduleTitle: "",*/
               ...
               /* sqlFormValidate:{
                ...
                functionList:[{"name":"SUM,DBSUM,AVERAGE,DBAVERAGE,MIN,DBMIN,MAX,DBMAX"}], //函数集合
                newFunctionList:[],
                interpretation:"",
                leftFunctionIndex:-1, //父级选中样式坐标
            ...
            selectAdvancedList(name){
                ...
                if (textr != "" && textr.indexOf("#{") != -1){
                    if (name === 'dynamic'){
                        ...
                        let text = xs.data.rows["_"][data.sri].cells[data.sci].text;
                        text=text.replace("dynamic(","").replace(")","").replace(")","");
