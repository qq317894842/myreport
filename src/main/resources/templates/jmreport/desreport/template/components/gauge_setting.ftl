    ...
    <Submenu name="20" style="border-bottom: inset 1px;">
        ...
        <div class="blockDiv" style="padding-bottom: 10px">
            ...
            <Row class="ivurow" v-if="typeof gaugeOption.title_textStyle_color !== 'undefined'">
                <p>标题颜色&nbsp;&nbsp;</p>
                <Col>
                <i-input v-model="gaugeOption.title_textStyle_color" size="small" style="width: 111px;" @on-change="onGaugeChange">
                    <span slot="append">
            ...
            <Row class="ivurow" v-if="typeof gaugeOption.itemStyle_color !== 'undefined'">
                <p>指针颜色&nbsp;&nbsp;</p>
                <Col>
                <i-input v-model="gaugeOption.itemStyle_color" size="small" style="width: 111px;" @on-change="onGaugeChange">
                    <span slot="append">
            ...
            <Row class="ivurow" v-if="typeof gaugeOption.detail_textStyle_color !== 'undefined'">
                <p>指针字体颜色&nbsp;&nbsp;</p>
                <Col>
                <i-input v-model="gaugeOption.detail_textStyle_color" size="small" style="width: 111px;" @on-change="onGaugeChange">
                           <span slot="append">
