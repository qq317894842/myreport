<script type="text/x-template" id="pictorial-setting-template">
    <Submenu  name="8" style="border-bottom: inset 1px;">
        ...
        <div class="blockDiv" style="padding-bottom: 10px">
            ...
            <Row class="ivurow" >
                <p>图标大小&nbsp;&nbsp;</p>
                <i-input size="small" v-model="pictorialOptions.symbolSize" @on-blur="onPictorialChange" style="width: 111px;"></i-input>
            </Row>
            <Row class="ivurow">
                <p>图标间距&nbsp;&nbsp;</p>
                <i-input  type="number" size="small" :value="util.getNumberFromPercent(pictorialOptions.symbolMargin,'!')" @on-blur="(e)=>onPercentChange(e.target.value, 'pictorialOptions.symbolMargin','onPictorialChange','!')" style="width: 111px;"> <span slot="append">%</span></i-input>
            </Row>

            <Row class="ivurow" >
                <p>最大值&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                <i-input size="small" v-model="pictorialOptions.symbolBoundingData" @on-blur="onPictorialChange" style="width: 111px;"></i-input>
            </Row>

            <Row class="ivurow">
                <p>是否补全&nbsp;&nbsp;</p>
                <i-switch size="small" style="margin-left: 85px;" v-model="pictorialOptions.double" @on-change="onPictorialChange"/>
            </Row>
