    ...
    <Submenu  name="10" style="border-bottom: inset 1px;">
        ...
        <div class="blockDiv" >
            <Row class="ivurow" v-for="(item,index) in radarOption[0].indicator" :key="index">
                ...
                <i-input size="small" type="number" v-model="item.max" @on-blur="onRadarChange" style="width: 81px;"></i-input>
            </Row>
            <Row class="ivurow">
                <p>字体大小&nbsp;&nbsp;</p>
                <i-input size="small" type="number" v-model="radarOption[0].name_textStyle_fontSize" @on-blur="onRadarChange" style="width: 111px;"></i-input>
            </Row>
            <Row class="ivurow" v-if="typeof radarOption[0].name_textStyle_color!== 'undefined'">
                <p>字体颜色&nbsp;&nbsp;</p>
                <i-input v-model="radarOption[0].name_textStyle_color" size="small" style="width: 111px;" @on-change="onRadarChange">
                    <span slot="append">
            ...
            <Row class="ivurow" v-if="typeof radarOption[0].axisLine_lineStyle_color!== 'undefined'">
                <p>轴线颜色&nbsp;&nbsp;</p>
                <i-input v-model="radarOption[0].axisLine_lineStyle_color" size="small" style="width: 111px;" @on-change="onRadarChange">
                    <span slot="append">
